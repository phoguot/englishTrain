---
name: "source-command-xong-chua"
description: "Chạy quality gate trước khi coi một nghiệp vụ là hoàn thành"
---

# source-command-xong-chua

Use this skill when the user asks to run the migrated source command `xong-chua`.

## Command Template

Chạy quality gate cho phần code vừa làm. Theo checklist `.Codex/rules/04-testing.md`.
